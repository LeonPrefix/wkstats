(function () {
  document.title = "wkstats: Joyo Coverage";
  ...
  let data;
  function draw_chart() {
    let content = $('section[name="charts-joyo"] .chart');
    content.html("");
  ...
  function process_items_snapshot() {
    ...
    data = joyo.kanji_by_level.map((group) => {
